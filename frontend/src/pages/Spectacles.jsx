...
const Spectacles = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error("Error fetching spectacles advice:", error);
  ...
  return (
    <div className="p-8 rounded-lg bg-white shadow-md">
      ...
      <p className="text-base mb-6 text-brand-charcoal">
        Upload your photo to find the best spectacles for your face.
      </p>

      <label
        htmlFor="spectacles-advisor-upload"
      ...
      {result && (
        <div className="mt-6 p-4 bg-brand-cream border border-brand-lavender rounded-lg shadow-inner">
          <h3 className="text-lg font-semibold text-brand-charcoal mb-2">Spectacles Advice:</h3>
          <p className="text-brand-plum"><strong>Suitability:</strong> {result.suitability}</p>
